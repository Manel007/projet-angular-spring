...
import { BlocServiceService } from  '../bloc-service.service'; // Assurez-vous de remplacer le chemin réel de votre service
import { FoyerServiceService } from  '../foyer-service.service'; // Assurez-vous de remplacer le chemin réel de votre service
